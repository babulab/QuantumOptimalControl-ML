...
class QuantumEnv(gym.Env):
    def __init__(self, circuit_fn, n_thetas, initial_state, target_state, num_qubits):
    ...
    def step(self, action):
        ...
        _, reward, _ = get_expectation_values(self.circuit_fn, self.state[np.newaxis,:], self.initial_state, self.target_state, self.num_qubits )
        #reward is the same than -fidelity
        reward = -reward
        ...
        self.best_log['fidelity'].append(-self.best_value)
